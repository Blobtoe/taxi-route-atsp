...
class branch_n_bound {
    using city_p_queue =
        std::priority_queue<City, std::vector<City>, City::compare>;
   ...
   private:
    ...
    void handle_city(City& city, std::shared_ptr<Container> container,
                     Path& best_path);
    void push_child_cities(City& parent_city,
